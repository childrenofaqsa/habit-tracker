...
export type MyDayHabitFilters = {
  ...
  priorities: Priority[];
  /**
   * When true, the habit was just toggled and is within its grace period, so
   * the completed/discarded filters are skipped to keep it briefly visible.
   */
 ...
 * bypasses the completed/discarded filters so the user can see what they ticked
 * before it filters out.
 */
